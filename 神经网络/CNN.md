...
- [CNN的结构组成](#CNN的结构组成)
  ...
  - [Fully_Connected layer](#Fully_Connected_layer)
...
<div align="center"><img src="./picture/只与一部分有关.png" height="" /></div> 

- 而传统神经网络中，由于都是全连接，所以输出的任何一个单元，都要受输入的所有的单元的影响。这样无形中会对图像的识别效果大打折扣。比较，每一个区域都有自己的专属特征，我们不希望它受到其他区域的影响。

--------------------------------------------------
## 致谢
- 本文大部分内容转自简书Stack_emtpy[深度学习笔记系列第六章](https://www.jianshu.com/p/c0215d26d20a);
- 在文中有几处添加了自己的理解，由于本人是刚入门的小白，理解难免会有偏差，请多包容和指正。
